const fs = require('fs');
const filePath = 'src/data/wecData.ts';
...
// Replace standings2025
data = data.replace(/export const standings2025 = \{[\s\S]*?(?=export const standings2024)/, replacement2025 + '\n\n');

// Replace standings2024
data = data.replace(/export const standings2024 = \{[\s\S]*?(?=export const allSeasons)/, replacement2024 + '\n\n');
