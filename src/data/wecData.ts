...
export interface Manufacturer {
  ...
  color: string;
  logo?: string;
  // WEC Hypercar era stats (2012–present)
  wecChampionships: number;
  leMansWins: number;
  wecRaceWins: number;
  poles: number;
  fastestLaps: number;
...
export const manufacturers: Manufacturer[] = [
  {
    ...
    wecDebut: 2023,
    activeCars: ['#50', '#51'],
    currentCar: 'Ferrari 499P',
    engine: '3.0L Twin-Turbo V6 Hybrid',
    about: 'Ferrari returned to top-level prototype racing in 2023 after a 50-year absence and immediately dominated, winning Le Mans on debut and back-to-back Manufacturers Championships in 2024 and 2025.',
  },
  {
    id: 'toyota',
    name: 'Toyota',
    ...
    wecDebut: 2012,
    activeCars: ['#7', '#8'],
    currentCar: 'Toyota GR010 Hybrid',
    engine: '3.5L Twin-Turbo V6 Hybrid',
    about: 'The most successful manufacturer in modern WEC history. Toyota dominated for years before Ferrari\'s arrival, winning 7 championships and 6 Le Mans. Their hybrid technology set the benchmark for the Hypercar era.',
  },
  {
    id: 'porsche',
    name: 'Porsche',
    ...
    wecDebut: 2023,
    activeCars: ['#5', '#6'],
    currentCar: 'Porsche 963',
    engine: '4.6L Twin-Turbo V8 Hybrid',
    about: 'Porsche holds the all-time Le Mans record with 19 overall victories. Returning to top-flight prototype racing in 2023 with the 963, they won the 2024 Drivers Championship through Lotterer/Estre/Vanthoor.',
  },
  {
    id: 'cadillac',
    name: 'Cadillac',
    ...
    wecDebut: 2023,
    activeCars: ['#2', '#3'],
    currentCar: 'Cadillac V-Series.R',
    engine: '5.5L Naturally Aspirated V8 Hybrid',
    about: 'The American challenger. Cadillac entered WEC in 2023 with the V-Series.R, the only naturally aspirated Hypercar on the grid. Strong development pace has made them consistent frontrunners.',
  },
  {
    id: 'bmw',
    name: 'BMW',
    ...
    wecDebut: 2024,
    activeCars: ['#15', '#20'],
    currentCar: 'BMW M Hybrid V8',
    engine: '4.0L Twin-Turbo V8 Hybrid',
    about: 'BMW returned to Le Mans after a 20-year absence in 2024. The M Hybrid V8 showed strong one-lap pace from the start and has been finding consistent race pace as the programme matures.',
  },
  {
    id: 'alpine',
    name: 'Alpine',
    ...
    wecDebut: 2024,
    activeCars: ['#35', '#36'],
    currentCar: 'Alpine A424',
    engine: '3.4L Twin-Turbo V6 Hybrid',
    about: 'Alpine transitioned from LMP1 origins to a full Hypercar in 2024. The French manufacturer brings Renault Group backing and significant motorsport heritage to the Hypercar grid.',
  },
  {
    id: 'peugeot',
    name: 'Peugeot',
    ...
    wecDebut: 2022,
    activeCars: ['#93', '#94'],
    currentCar: 'Peugeot 9X8',
    engine: '2.6L Twin-Turbo V6 Hybrid',
    about: 'The most unconventional Hypercar on the grid. The 9X8 originally raced without a rear wing — a bold aerodynamic concept. Peugeot has strong Le Mans history from the Group C era.',
  },
  {
    id: 'aston-martin',
    name: 'Aston Martin',
    ...
    wecDebut: 2025,
    activeCars: ['#007', '#009'],
    currentCar: 'Aston Martin Valkyrie AMR Pro',
    engine: '6.5L Naturally Aspirated V12 Hybrid (Cosworth)',
    about: 'The most exotic car on the grid. The Valkyrie is derived from an £2.5M+ road hypercar. Powered by a screaming Cosworth V12 revving to 11,000 RPM, it sounds unlike anything else in motorsport. The #007 car number is a nod to Aston Martin\'s James Bond heritage.',
  },
];
